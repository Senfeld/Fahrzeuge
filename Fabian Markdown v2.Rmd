...
adjust_classes <- function(df) {
  # Anpassung der Klassen gemäß Ihren Anforderungen
  df <- df %>%
...
cleaning_Komponenten <- function(Komponente){
  ...
  data <- data[,-c(1,2)]
  clean_component <- cleaner_komponente(data)
