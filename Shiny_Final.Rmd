...
# UI
ui <- fluidPage(
  titlePanel("Autokarte und Datenanalyse"),
  tabsetPanel(
    tabPanel("Suche",
             fluidPage(
    ...
    tabPanel("Nutzungsdauer - Vergleich",
             fluidPage(
               titlePanel("Nutzungsdauer - Vergleich"),
  theme = shinytheme("cerulean"),
  tabPanel("Vergleich",
           fluidPage(
             tags$style(HTML('
                             /* Ändern der Hintergrundfarbe des Textinputs */
                             ...
                             /* Ändern der Schriftfarbe des Textinputs */
                             .shiny-input-container input[type="text"]::placeholder {
                               color: gray;
                             }

                             /* Ändern des Aussehens des Buttons */
                             .btn-primary {
                               background-color: lightsteelblue;
                             ...
                             /* Ändern des Aussehens des Buttons bei Hover */
                             .btn-primary:hover {
                               background-color: #99c2ff; /* Helleres Blau für Hover-Effekt */
                               border-color: #99c2ff;
                             }
                           '))
             ,
...
server <- function(input, output, session) {
  ...
  output$boxplot <- renderPlotly({
    ...
    p1 <- plot_ly(PLZ1, x = ~Postleitzahl, y = ~Komponente_Fehlerhaft_Fahrleistung, 
                  ...
                  marker = list(color = 'rgb(12, 133, 200)')) %>%
    ...
    p2 <- plot_ly(PLZ2, x = ~Postleitzahl, y = ~Komponente_Fehlerhaft_Fahrleistung, 
                  ...
                  marker = list(color = 'rgb(245, 74, 32)')) %>%
