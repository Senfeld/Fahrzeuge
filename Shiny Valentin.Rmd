...
ui <- fluidPage(
  ...
  tabsetPanel(type = "tabs",
              ...
              tabPanel("Produktionsmenge", 
                       fluidRow(
               column(6, dateInput("from_date", "Produktionszeitraum von", value = "2012-06-01")),
               column(6, dateInput("to_date", "Produktionszeitraum bis", value = "2014-07-31")),
...
# })
  ...
  output$histogram <- renderPlot({
    ...
    ggplot(filtered_data(), aes(x = OEM_Ort)) +
      ...
      labs(title = "Produktionsmengen Histogram", x = "OEM Ort", y = "Count")
  })
